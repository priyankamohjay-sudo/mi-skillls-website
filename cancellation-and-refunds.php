...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        ...
        <title> Mi Skills  |   Cancellation & Refund Policy</title>
  </head>
      ...
      <div class="col-12 col-lg-9 mx-auto">
        <div class="post-main-area">
          <div class="post-content">
            ...
            <p class="post-text">
              Users may stop using the service at any time, but no partial or prorated refunds will be issued for unused time.
            </p>

            <h2 class="post-heading">2. Refund Eligibility</h2>
            <p class="post-text">
              MISKILLS provides instant access to digital learning content; therefore, subscription payments are generally non-refundable.
            </p>
            <p class="post-text">
            ...
            <p class="post-text">
              Approved refunds will be processed to the original payment method within 5–7 business days as per Razorpay’s
