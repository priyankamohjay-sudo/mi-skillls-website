...
<head>
    ...
    <meta name="description" content="Transform your career with our digital marketing course. Discover proven methods and insights to excel in the fast-paced digital marketplace.">
    <meta name="keywords" content="digital marketing course, digital marketing classes, course marketing digital, class digital marketing">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
       ...
       <link rel="icon" href="assets/images/fav-icon/logo-new.png">
        ...
        <title>Transform Your Career with Our Digital Marketing Course</title>
  </head>
        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/services/marketing.jpg" alt="featured image"></div>
              <div class="service-content">
                  ...
                  <div class="two-cols-img ">
                    <div class="row">
                      <div class="col-12 col-md-6 mb-3">
                        <div class="img-col"><img class="img-fluid" src="assets/images/services/marketing-1.jpg" loading="lazy" alt="service single image "></div>
                      </div>
                      <div class="col-12 col-md-6">
                        <div class="img-col"><img class="img-fluid" src="assets/images/services/marketing-2.jpg" loading="lazy" alt="service single image "></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="part">
                  ...
                  <p class="service-text">Search Engine Optimization :</p>
                    <p class="info-text">Learn how to optimize websites to rank higher on search engines and attract organic traffic.</p>
                  <ul>
                  <li>Keyword research and search intent analysis</li>
                  <li>On-page SEO (titles, meta tags, content optimization)</li>
                  <li>Technical SEO basics (site speed, mobile-friendliness)</li>
                  <li>Off-page SEO and link-building fundamentals</li>
                  <li>SEO tools, analytics, and performance tracking</li>
                  </ul>
                </div>

                  <div class="part">
                  <p class="service-text">Social Media Optimization :</p>
                  <p class="info-text">Understand how to grow brands on social media platforms through strategy, engagement, and consistency.</p>
                  <ul>
                  <li>Social media strategy and brand positioning</li>
                  <li>Platform optimization for better reach and engagement</li>
                  <li>Content planning and posting consistency</li>
                  <li>Audience growth and engagement techniques</li>
                  <li>Social media insights and performance analysis</li>
   
                  </ul>
                </div>

                 <div class="part">
                  <p class="service-text">Content Writing</p>
                  <p class="info-text">Create high-quality, SEO-friendly content that attracts, engages, and converts audiences.</p>
                  <ul>             
                    <li>Writing SEO-friendly website and blog content</li>
                  <li>Content structure, headlines, and storytelling</li>
                  <li>Writing for social media, landing pages, and ads</li>
                  <li>Keyword placement and content optimization</li>
                  <li>Editing, readability, and content quality improvement</li>
                  </ul>
                </div>
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            <h5 class="info-title">Industry-Relevant Skills</h5>
                            <p class="info-text">Learn practical digital marketing techniques that are currently used by brands and agencies.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            <h5 class="info-title">Focus on Core Marketing Channels</h5>
                            <p class="info-text">Master SEO, SMO, and Content Writing—the foundation of successful digital marketing.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            <h5 class="info-title">Practical & Easy-to-Learn Approach</h5>
                            <p class="info-text">Hands-on learning designed for beginners and professionals alike.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            <h5 class="info-title">Career & Freelance Opportunities</h5>
                            <p class="info-text">Build skills that help you get jobs, internships, or start freelancing in digital marketing.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="card mb-2">
                        <div class="card-header " id="heading-1">
                          <h5 class="mb-0 faq-title">
                            <button class="btn btn-link  faq-btn  collapsed " data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">Will I get hands-on practical experience?</button>
                          </h5>
                        </div>
                        <div class="collapse " id="collapse-1" aria-labelledby="collapse-1" data-bs-parent="#accordion">
                          <div class="card-body">
                            <p class="faq-answer">Yes, the course focuses on real-world examples, assignments, and practical exercises to help you apply what you learn.</p>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-2">
                        <div class="card-header " id="heading-2">
                          <h5 class="mb-0 faq-title">
                            <button class="btn btn-link  faq-btn  collapsed " data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="true" aria-controls="collapse-2">How will this course help my career?</button>
                          </h5>
                        </div>
                        <div class="collapse " id="collapse-2" aria-labelledby="collapse-2" data-bs-parent="#accordion">
                          <div class="card-body">
                            <p class="faq-answer">This course prepares you for roles in digital marketing, content marketing, SEO, and social media management, as well as freelancing opportunities.</p>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-2">
                        <div class="card-header " id="heading-3">
                          <h5 class="mb-0 faq-title">
                            <button class="btn btn-link  faq-btn  collapsed " data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="true" aria-controls="collapse-3">Are tools and real strategies covered?</button>
                          </h5>
                        </div>
                        <div class="collapse " id="collapse-3" aria-labelledby="collapse-3" data-bs-parent="#accordion">
                          <div class="card-body">
                            <p class="faq-answer">Yes, you will learn how to use industry-relevant tools and strategies to track performance and improve results.</p>
                          </div>
                        </div>
            ...
            <div class="service-sidebar ">
              <div class="sidebar-pane">
                ...
                <ul class="list">
                  ...
                  <li class="list-item active"><i class="flaticon-nanotechnology font-icon"></i><a href="digital-marketing.php"> Digital Marketing<i class="bi bi-arrow-right icon "></i></a></li>
