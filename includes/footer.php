...
<footer class="page-footer dark-color-footer" id="page-footer">
  <div class="overlay-photo-image-bg" data-bg-img="<?= BASE_URL ?>assets/images/sections-bg-images/footer-bg-1.jpg"
    data-bg-opacity=".25"></div>
  <div class="container">
    <div class="row footer-cols">
      <div class="col-12 col-md-8 col-lg-3  footer-col "><img class="img-fluid footer-logo" loading="lazy"
          src="<?= BASE_URL ?>assets/images/logo/logo-white-new.png" alt="logo" />
      ...
      <div class="col-12 col-md-6 col-lg-2 footer-col ">
        ...
        <div class="footer-col-content-wrapper">
          <ul class="footer-menu">
            ...
            <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link"
                href="<?= BASE_URL ?>terms-and-conditions">Terms & Conditions</a>
            </li>
            <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link"
                href="<?= BASE_URL ?>cancellation-and-refunds">Cancellation & Refund Policy</a>
            </li>
            <li class="footer-menu-item"><i class="bi bi-arrow-right icon "></i><a class="footer-menu-link"
                href="<?= BASE_URL ?>shipping-policy">Shipping Policy</a>
            </li>
          </ul>
        </div>
      </div>
...
<div class="loading-screen" id="loading-screen"><span class="bar top-bar"></span><span class="bar down-bar"></span><span
    class="progress-line"></span><span class="loading-counter"> </span></div>
    ...
    <div class="modal-content text-dark">
      ...
      <div class="modal-body">
        <div class="content">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores saepe, labore sequi libero nesciunt
            optio quidem iste, dolorum nostrum ex at. Recusandae ducimus aut autem temporibus tempore rerum,
            consequuntur doloribus perspiciatis, labore totam dolorem veritatis repellendus omnis illo sint ut?</p>
        </div>
        <div class="content">
          <h4>privacy policy item Title goes here </h4>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores saepe, labore sequi libero nesciunt
...
<!--     JQuery     -->
<script src="<?= BASE_URL ?>assets/js/vendors/jquery-3.6.1.min.js"></script>
...
<!--     fancybox     -->
<script src="<?= BASE_URL ?>assets/js/vendors/jquery.fancybox.min.js"></script>

<!--     particles     -->
<script src="<?= BASE_URL ?>assets/js/vendors/particles.min.js"></script>
