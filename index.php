<?php
$title="Discover the Best Online Course Platform for Learning";
$description="Join our online course platform today! Access a wide range of courses, connect with industry experts, and enhance your learning experience anytime, anywhere.";
$tags = "online course platform, online class platform, digital marketing classes, courses on web development";
    ...
    <div class="hero-text-area content-always-light">
      <div class="row g-0">
        ...
        <div class="col-12 col-lg-8">
          <div class="row">
            ...
            <div class="col-12 col-md-10">
              <p class="info-text">
                MI Skills offers expert-led live courses to build industry-ready skills, along with scheduled interview
                opportunities to support career growth.
              </p>
            </div>
        ...
        <div class="col-12 col-lg-4 d-flex align-items-center">
          <div class="download-buttons-wrapper d-flex flex-column gap-3 ms-lg-auto">

            <a class="download-btn" href="https://testflight.apple.com/join/h3VzsnAh" target="_blank" rel="noopener">
              <span class="text"><i class="fab fa-apple me-2"></i> Download From App Store</span>
            </a>

            <a class="download-btn"
              href="https://play.google.com/store/apps/details?id=com.skill.my&pcampaignid=web_share&pli=1"
              target="_blank" rel="noopener">
              <span class="text"><i class="fab fa-google-play me-2"></i> Download From Play Store</span>
            </a>

            <a class="download-btn"
              href="https://github.com/js-mohjay/miskills-desktop-updater/releases/download/v1.0.6/miskills-1.0.6-setup.exe"
              target="_blank" rel="noopener">
...
<section class="about " id="about">
  <div class="overlay-photo-image-bg" data-bg-img="<?=BASE_URL?>assets/images/sections-bg-images/pattern-bg-2.jpg"
        ...
        <div class="col-12 col-lg-6 d-flex align-items-center order-1 order-lg-0 about-col pad-end  wow fadeInUp "
          ...
          <div class="text-area ">
            <div class="sec-heading  light-title ">
              <div class="content-area"><span class=" pre-title wow fadeInUp " data-wow-delay=".2s">About MI
                  Skills</span>
                <h2 class=" title wow fadeInUp" data-wow-delay=".4s">Empowering Students for Career <span
                    class='featured-text'>Success <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150"
                      preserveAspectRatio="none">
                      <path d="M7.7,145.6C109,125,299.9,116.2,401,121.3c42.1,2.2,87.6,11.8,87.3,25.7"></path>
                    </svg></span></h2>
              </div>
            </div>
            <p class=" about-text">MI Skills is a career-focused learning platform that offers live online courses
              designed to help students build practical, real-world skills. We focus on interactive learning, expert
              guidance, and hands-on practice to support skill development and career growth. Along with learning, MI
  ...
  <div class="cta-wrapper">
    <div class="container">
      <div class="sec-heading  centered mb-0 ">
        ...
        <p class="info-text   wow fadeInUp " data-wow-delay=".6s">Learn through live online classes, track interviews,
          internships, and job opportunities, and manage your courses seamlessly <br>on the MI Skills App—available on
          Play Store, App Store, and Desktop for learning anytime, anywhere.</p>
      </div>
    </div>

    <div class="see-more-area wow fadeInUp pt-5 d-flex justify-content-center gap-4" data-wow-delay="0.8s">

      <a class="btn btn-dark cta-link px-4 py-2 d-inline-flex align-items-center gap-2" target="_blank"
        href="https://play.google.com/store/apps/details?id=com.skill.my&pcampaignid=web_share&pli=1"><i
          class="bi bi-google-play fs-5"></i>
        Get it on Play Store</a>

      <a class="btn btn-dark cta-link px-4 py-2 d-inline-flex align-items-center gap-2" target="_blank"
        href="https://github.com/js-mohjay/miskills-desktop-updater/releases/download/v1.0.6/miskills-1.0.6-setup.exe"><i
          class="bi bi-windows fs-5"></i>
...
<section class="stats js-stats-counter mega-section">
  <div class="overlay-photo-image-bg" data-bg-img="<?=BASE_URL?>assets/images/sections-bg-images/pattern-bg-3.jpg"
    data-bg-opacity=".2"></div>
  <div class="container">
      ...
      <div class="row ">
        ...
        <div class="col-12 col-md-6 col-lg-3 stat-box ">
          <div class="stat-box-inner" data-tilt="data-tilt"><i class="flaticon-user stat-icon"></i>
            <p class="stat-num "><span class="counter" data-from="0" data-to="25" data-speed="3000"
                data-refresh-interval="50"></span><span class="sign">+</span></p>
            <h4 class="stat-desc">Our Instructors</h4>
          </div>
        </div>
        <!--Info Four-->
        <div class="col-12 col-md-6 col-lg-3 stat-box ">
          <div class="stat-box-inner" data-tilt="data-tilt"><i class="flaticon-aim stat-icon"></i>
            <p class="stat-num "><span class="counter" data-from="0" data-to="1800" data-speed="3000"
                data-refresh-interval="50"></span><span class="sign">+</span></p>
            <h4 class="stat-desc">Total Students Enrolled</h4>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="text-area ">
          <div class="sec-heading  light-title ">
            <div class="content-area"><span class=" pre-title wow fadeInUp " data-wow-delay=".2s">why choose us</span>
              <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">Why <span class='hollow-text'> Choose</span> <span
                  class='featured-text'>MI Skills <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150"
                    preserveAspectRatio="none">
                    <path d="M7.7,145.6C109,125,299.9,116.2,401,121.3c42.1,2.2,87.6,11.8,87.3,25.7"></path>
                  </svg></span></h2>
            </div>
          </div>
          <!-- <p class=" about-text">MI Skills helps students build skills through proper training, prepare for interviews, and connect with real job opportunities to support long-term career growth.</p> -->
          <div class="info-items-list">
            <div class="row ">
              <div class="col-12 ">
                <div class="info-item"><span class="info-number ">01.</span>
                  <div class="info-content">
                    <h5 class="info-title">Training And Skill Development</h5>
                    <p class="info-text">We provide structured training through live classes that help students learn
                      practical skills and gain confidence for real-world work.</p>
                  </div>
                </div>
              </div>
              <div class="col-12 ">
                <div class="info-item"><span class="info-number ">02.</span>
                  <div class="info-content">
                    <h5 class="info-title">Interview Schedule</h5>
                    <p class="info-text">Our platform offers scheduled interview opportunities, helping students
                      practice, prepare, and connect with hiring companies.</p>
                  </div>
                </div>
              </div>
              <div class="col-12 ">
                <div class="info-item"><span class="info-number ">03.</span>
                  <div class="info-content">
                    <h5 class="info-title">Job Opportunities</h5>
                    <p class="info-text">We support students with career guidance and job opportunities, helping them
                      move from learning to employment smoothly.</p>
                  </div>
                </div>
              </div>
            </div>
...
<section class="pricing mega-section has-dark-bg" id="pricing-1">
  ...
  <div class="pricing-bg-elements">
    <span class="design-element dots el-1"></span>
    <span class="design-element rounded-shape el-2"></span>
  </div>
  ...
  <div class="container position-relative">
    ...
    <div class="sec-heading">
      <div class="content-area">
        ...
        <p class="info-text wow fadeInUp" data-wow-delay=".6s">
          MI Skills offers flexible and affordable pricing plans with access to live classes,
...
<section class="testimonials testimonials-1-col   has-dark-bg  mega-section " id="testimonials-img-bg">
  <div class="overlay-photo-image-bg parallax " data-bg-img="<?=BASE_URL?>assets/images/sections-bg-images/1.jpg"
    data-bg-opacity=".25"> </div>
  <div class="container">
    <div class="sec-heading  centered ">
      <div class="content-area"><span class=" pre-title  wow fadeInUp " data-wow-delay=".2s">testimonials</span>
        <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">Student <span class='hollow-text'>Reviews & Feedback
          </span></h2>
      </div>
    </div>
          ...
          <div class="swiper-wrapper">
              ...
              <div class="testmonial-card d-flex align-items-center justify-content-center">
                <div class="testimonial-content">
                  <div class="customer-img "><img class="img-fluid " loading="lazy"
                      src="<?=BASE_URL?>assets/images/testimonials/user1.png" alt="First Slide "></div>
                  <div class="customer-testimonial">
                    <div class="content">
                      <p class="testimonial-text ">MI Skills helped me learn through live classes with clear guidance.
                        After completing my course, I got interview opportunities support that boosted my confidence.
                        The learning experience feels very practical.</p>
                    </div>
                  </div>
                  <div class="customer-info ">
                    <div class="customer-details">
                      <p class="customer-name">Rohit Sharma</p>
            ...
            <div class="swiper-slide">
              <div class="testmonial-card d-flex align-items-center justify-content-center">
                <div class="testimonial-content">
                  <div class="customer-img "><img class="img-fluid " loading="lazy"
                      src="<?=BASE_URL?>assets/images/testimonials/user2.png" alt="First Slide "></div>
                  <div class="customer-testimonial">
                    <div class="content">
                      <p class="testimonial-text ">The live classes at MI Skills are easy to understand and very
                        interactive. What I liked most is the internship opportunities that helped me apply my skills in
                        real projects.</p>
                    </div>
                  </div>
                  <div class="customer-info ">
                    <div class="customer-details">
                      <p class="customer-name">Priya Verma</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testmonial-card d-flex align-items-center justify-content-center">
                <div class="testimonial-content">
                  <div class="customer-img "><img class="img-fluid " loading="lazy"
                      src="<?=BASE_URL?>assets/images/testimonials/user3.png" alt="First Slide "></div>
                  <div class="customer-testimonial">
                    <div class="content">
                      <p class="testimonial-text ">The live learning environment, interview preparation, and internship
                        scheduling made MI Skills different from other platforms. I feel more prepared for real job
                        opportunities now.</p>
                    </div>
                  </div>
                  <div class="customer-info ">
                    <div class="customer-details">
                      <p class="customer-name">Karan Mehta</p>
            ...
            <div class="swiper-slide">
              <div class="testmonial-card d-flex align-items-center justify-content-center">
                <div class="testimonial-content">
                  <div class="customer-img "><img class="img-fluid " loading="lazy"
                      src="<?=BASE_URL?>assets/images/testimonials/user4.png" alt="First Slide "></div>
                  <div class="customer-testimonial">
                    <div class="content">
                      <p class="testimonial-text ">I had a project idea but didn’t know how to start. MI Skills guided
                        me with mentorship and gave me an opportunity to apply for business funding. It gave me
                        confidence to work on my idea seriously.</p>
                    </div>
                  </div>
                  <div class="customer-info ">
                    <div class="customer-details">
                      <p class="customer-name">Neha Singh</p>
              ...
              <div class="testmonial-card d-flex align-items-center justify-content-center">
                <div class="testimonial-content">
                  <div class="customer-img ">
                    <img class="img-fluid" loading="lazy" src="<?=BASE_URL?>assets/images/testimonials/user-5.webp"
                      alt="Student Review">
                  </div>
                  <div class="customer-testimonial">
                    <div class="content">
                      <p class="testimonial-text">
                        MI Skills live classes helped me understand concepts clearly, even as a beginner. The interview
                        scheduling support made the learning feel career-oriented, not just theoretical.
                      </p>
                    </div>
                  </div>
                  <div class="customer-info">
            ...
            <div class="swiper-slide">
              <div class="testmonial-card d-flex align-items-center justify-content-center">
                <div class="testimonial-content">
                  <div class="customer-img ">
                    <img class="img-fluid" loading="lazy" src="<?=BASE_URL?>assets/images/testimonials/user-6.png"
                      alt="Student Review">
                  </div>
                  <div class="customer-testimonial">
                    <div class="content">
                      <p class="testimonial-text">
                        The trainers at MI Skills explain everything with real examples. I also received proper guidance
                        for interviews, which helped me feel more confident while applying for jobs.
                      </p>
                    </div>
                  </div>
                  <div class="customer-info">
            ...
            <div class="swiper-slide">
              <div class="testmonial-card d-flex align-items-center justify-content-center">
                <div class="testimonial-content">
                  <div class="customer-img ">
                    <img class="img-fluid" loading="lazy" src="<?=BASE_URL?>assets/images/testimonials/user-7.webp"
                      alt="Student Review">
                  </div>
                  <div class="customer-testimonial">
                    <div class="content">
                      <p class="testimonial-text">
                        What makes MI Skills unique is the combination of live classes and job interview opportunities.
                        It feels like a complete learning-to-placement journey.
                      </p>
                    </div>
                  </div>
                  <div class="customer-info">
            ...
            <div class="swiper-slide">
              <div class="testmonial-card d-flex align-items-center justify-content-center">
                <div class="testimonial-content">
                  <div class="customer-img ">
                    <img class="img-fluid" loading="lazy" src="<?=BASE_URL?>assets/images/testimonials/user-8.webp"
                      alt="Student Review">
                  </div>
                  <div class="customer-testimonial">
                    <div class="content">
                      <p class="testimonial-text">
                        MI Skills helped me move from basic knowledge to real-world skills. The mentorship and interview
                        support gave me clarity about my career path.
                      </p>
                    </div>
                  </div>
                  <div class="customer-info">
...
<!-- <section class="our-clients  mega-section   wow fadeInUp" id="our-clients" data-wow-delay="0.2s">
      <div class="container">
        <div class="sec-heading   centered ">
          <div class="content-area">
            <h2 class=" title    wow fadeInUp " data-wow-delay=".4s">Trusted by over 50+ brands</h2>
          </div>
        </div>
        <div class=" clients-logos ">
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper clients-logo-wrapper wow fadeIn " data-wow-delay=".02s">
              ...
              <div class="swiper-slide">
                <div class="client-logo  "><a href="#0"><img class="img-fluid logo " loading="lazy" src="<?=BASE_URL?>assets/images/clients-logos/1-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="#0"><img class="img-fluid logo " loading="lazy" src="<?=BASE_URL?>assets/images/clients-logos/2-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="#0"><img class="img-fluid logo " loading="lazy" src="<?=BASE_URL?>assets/images/clients-logos/3-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="#0"><img class="img-fluid logo " loading="lazy" src="<?=BASE_URL?>assets/images/clients-logos/4-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="#0"><img class="img-fluid logo " loading="lazy" src="<?=BASE_URL?>assets/images/clients-logos/5-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="#0"><img class="img-fluid logo " loading="lazy" src="<?=BASE_URL?>assets/images/clients-logos/6-white.png" alt=" "></a></div>
              </div>
              <div class="swiper-slide">
                <div class="client-logo "><a href="#0"><img class="img-fluid logo " loading="lazy" src="<?=BASE_URL?>assets/images/clients-logos/7-white.png" alt=" "></a></div>
              </div>
            </div>
          </div>
        </div>
