...
<body class="dark-theme ">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="hero-social-icons mb-3">
                  <div class="sc-wrapper dir-row sc-flat">
                    <ul class="sc-list">
                      <li class="sc-item " title="Facebook"><a class="sc-link" target="_blank" href="#"
              ...
              <div class="col-10">
                <p class="hero-subtitle">
                  MI Skills offers expert-led live courses to build industry-ready skills,
                  along with scheduled interview opportunities to support career growth.
                </p>
              </div>
    ...
    <div class="container">
      <div class="sec-heading  ">
        <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">Our Courses</span>
          ...
          <p class="subtitle   wow fadeInUp " data-wow-delay=".6s">MI Skills offers live courses that build practical
            skills and support real career opportunity.</p>
        </div>
        <div class=" cta-area   wow fadeInUp" data-wow-delay=".8s"><a class="cta-btn btn-solid" href="courses.php">see
            all Courses <i class="bi bi-arrow-right icon "></i></a></div>
      </div>
        ...
        <div class="col-12 col-md-6  col-lg-4 mx-auto ">
          ...
          <div class="box service-box  wow fadeInUp reveal-start" data-wow-offset="0" data-wow-delay=".1s">
            ...
            <div class="service-content">
              ...
              <p class="service-text">This course covers essential web concepts frontent, backend and practical skills
                to create fast, user-friendly websites.</p>
    ...
    <div class="cta-wrapper">
      <div class="container">
        <div class="sec-heading  centered mb-0 ">
          ...
          <p class="subtitle   wow fadeInUp " data-wow-delay=".6s">Learn through live online classes, track interviews,
      ...
      <div class="see-more-area wow fadeInUp pt-5 d-flex justify-content-center gap-4" data-wow-delay="0.8s">
        ...
        <a class="btn btn-dark cta-link px-4 py-2 d-inline-flex align-items-center gap-2" target="_blank"
          href="https://github.com/js-mohjay/miskills-desktop-updater/releases/download/v1.0.4/miskills-1.0.4-setup.exe"><i
          ...
          <div class="col-12 col-md-6 col-lg-3 stat-box ">
            <div class="stat-box-inner  " data-tilt="data-tilt"><i class="flaticon-project-management stat-icon"></i>
              <p class="stat-num "><span class="counter" data-from="10" data-to="100" data-speed="3000"
                  data-refresh-interval="50"></span><span class="sign">+</span></p><span class="stat-desc">Hiring
                Partners</span>
            </div>
          </div>
          <!--Info Two-->
          <div class="col-12 col-md-6 col-lg-3 stat-box ">
            <div class="stat-box-inner  " data-tilt="data-tilt"><i class="flaticon-content-management stat-icon"></i>
              <p class="stat-num "><span class="counter" data-from="0" data-to="8" data-speed="3000"
                  data-refresh-interval="50"></span><span class="sign">+</span></p><span class="stat-desc">Total
                Courses</span>
            </div>
          </div>
          <!--Info Three-->
          <div class="col-12 col-md-6 col-lg-3 stat-box ">
            <div class="stat-box-inner  " data-tilt="data-tilt"><i class="flaticon-user stat-icon"></i>
              <p class="stat-num "><span class="counter" data-from="0" data-to="25" data-speed="3000"
                  data-refresh-interval="50"></span><span class="sign">+</span></p><span class="stat-desc">Our
                Instructors</span>
            </div>
          </div>
          <!--Info Four-->
          ...
          <div class="text-area ">
            <div class="sec-heading  light-title ">
              <div class="content-area"><span class=" pre-title wow fadeInUp " data-wow-delay=".2s">why choose us</span>
                <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">Why <span class='hollow-text'> Choose</span>
                  <span class='featured-text'>MI Skills <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150"
                      preserveAspectRatio="none">
                      <path d="M7.7,145.6C109,125,299.9,116.2,401,121.3c42.1,2.2,87.6,11.8,87.3,25.7"></path>
                    </svg></span>
                </h2>
              ...
              <div class="row ">
                <div class="col-12 ">
                  <div class="info-item"><span class="info-number ">01.</span>
                    <div class="info-content">
                      <h5 class="info-title">Training</h5>
                ...
                <div class="col-12 ">
                  <div class="info-item"><span class="info-number ">02.</span>
                    <div class="info-content">
                      <h5 class="info-title">Interview</h5>
  ...
  <section class="portfolio mega-section" id="portfolio">
    <div class="container">
      <div class="sec-heading  ">
        <div class="content-area"><span class=" pre-title wow fadeInUp " data-wow-delay=".2s">PLACEMENT &
            INTERNSHIP</span>
          <h2 class=" title  wow fadeInUp" data-wow-delay=".4s">Student Placement & Internship <span
              class='hollow-text'>Highlights</span></h2>
        </div>
        ...
        <div class="portfolio-group wow fadeIn" data-wow-delay=".4s">
          <div class="row ">
            ...
            <div class="col-12  col-md-6  col-lg-3  portfolio-item web  ">
              <div class="item   ">
                <a class="portfolio-img-link">
                  <img class="img-fluid" src="assets/images/portfolio/today-interview.png"
            ...
            <div class="col-12  col-md-6  col-lg-3  portfolio-item data ">
              <div class="item   ">
                <a class="portfolio-img-link">
                  <img class="img-fluid" src="assets/images/portfolio/interview-status.png"
                    alt="portfolio item photo" /></a>
            ...
            <div class="col-12  col-md-6  col-lg-3  portfolio-item data ">
              <div class="item   ">
                <a class="portfolio-img-link">
                  <img class="img-fluid" src="assets/images/portfolio/placement-dark.png"
                    alt="portfolio item photo" /></a>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="testmonial-card d-flex align-items-center justify-content-center">
                  <div class="testimonial-content">
                    <div class="customer-img "><img class="img-fluid " loading="lazy"
                        src="assets/images/testimonials/user1.png" alt="First Slide "></div>
              ...
              <div class="swiper-slide">
                <div class="testmonial-card d-flex align-items-center justify-content-center">
                  <div class="testimonial-content">
                    <div class="customer-img "><img class="img-fluid " loading="lazy"
                        src="assets/images/testimonials/user2.png" alt="First Slide "></div>
                    <div class="customer-testimonial">
                      <div class="content">
                        <p class="testimonial-text ">The live classes at MI Skills are easy to understand and very
                          interactive. What I liked most is the internship opportunities that helped me apply my skills
                          in real projects.</p>
                      </div>
                    </div>
                    <div class="customer-info ">
              ...
              <div class="swiper-slide">
                <div class="testmonial-card d-flex align-items-center justify-content-center">
                  <div class="testimonial-content">
                    <div class="customer-img "><img class="img-fluid " loading="lazy"
                        src="assets/images/testimonials/user3.png" alt="First Slide "></div>
                    <div class="customer-testimonial">
                      <div class="content">
                        <p class="testimonial-text ">The live learning environment, interview preparation, and
                          internship scheduling made MI Skills different from other platforms. I feel more prepared for
                          real job opportunities now.</p>
                      </div>
                    </div>
                    <div class="customer-info ">
                      <div class="customer-details">
              ...
              <div class="swiper-slide">
                <div class="testmonial-card d-flex align-items-center justify-content-center">
                  <div class="testimonial-content">
                    <div class="customer-img "><img class="img-fluid " loading="lazy"
                        src="assets/images/testimonials/user4.png" alt="First Slide "></div>
                    <div class="customer-testimonial">
                      <div class="content">
      ...
      <div class="container">
        <div class="sec-heading  centered mb-0 ">
          <div class="content-area"><span class=" pre-title wow fadeInUp " data-wow-delay=".2s">contact us</span>
            ...
            <p class="subtitle   wow fadeInUp " data-wow-delay=".6s">Our team at MI Skills is here to guide you at every
              step—from learning to real-world success. <br>Connect with us today and take the next step toward your
              career goals.</p>
          </div>
        </div>
        <!--Start .see-more-area-->
  ...
  <script>
    document.querySelectorAll('a[href="#take-action"]').forEach(link => {
      link.addEventListener('click', function (e) {
        ...
        const section = document.querySelector('#take-action');
