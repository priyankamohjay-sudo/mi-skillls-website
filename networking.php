        ...
        <div class="service-content-area">
          ...
          <div class="service-content">
            ...
            <div class="part">
              ...
              <p class="service-text">Networking Fundamentals :</p>
              <p class="info-text">
                Learn the core concepts required to understand and manage computer networks effectively.
              </p>
              <ul>
                ...
                <li>Basic networking terminology</li>
              </ul>
            </div>

            <div class="part">
              <p class="service-text">Network Devices & Configuration :</p>
              <p class="info-text">
                Understand how networking hardware operates and how networks are configured.
              </p>
              <ul>
                <li>Routers, switches, hubs, and firewalls</li>
                <li>IP addressing and subnetting basics</li>
                <li>Network configuration fundamentals</li>
                <li>Connecting devices in a network</li>
                <li>Basic network monitoring concepts</li>
              </ul>
            </div>

            <div class="part">
              <p class="service-text">Network Security & Troubleshooting :</p>
              <p class="info-text">
                Learn how to secure networks and identify and resolve common network issues.
              </p>
              <ul>
                <li>Network security fundamentals</li>
                <li>Firewall and access control basics</li>
                <li>Common network issues and solutions</li>
                ...
                <div class="row">
                  <div class="col-12 col-md-6 ">
                    <div class="info-item">
                      ...
                      <div class="info-content">
                        ...
                        <p class="info-text">
                          Learn networking skills that are used in real IT and corporate environments.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-6 ">
                    <div class="info-item">
                      ...
                      <div class="info-content">
                        <h5 class="info-title">Hands-On Networking Skills</h5>
                        <p class="info-text">
                          Gain practical knowledge of network setup, configuration, and troubleshooting.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-6 ">
                    <div class="info-item">
                      ...
                      <div class="info-content">
                        <h5 class="info-title">Beginner-Friendly Learning</h5>
                        <p class="info-text">
                          Start from networking basics and progress step by step.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-6 ">
                    <div class="info-item">
                      ...
                      <div class="info-content">
                        ...
                        <p class="info-text">
                          Prepare for roles such as Network Support Engineer, IT Support, and System Administrator.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="faq-accordion " id="accordion">
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="collapse" id="collapse-1" data-bs-parent="#accordion">
                      <div class="card-body">
                        <p class="faq-answer">
                          Yes, this course is beginner-friendly and starts from networking fundamentals.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card mb-2">
                    ...
                    <div class="collapse" id="collapse-3" data-bs-parent="#accordion">
                      <div class="card-body">
                        <p class="faq-answer">
                          Yes, basic network security concepts and best practices are included in the course.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="sidebar-pane">
            <div class="download-area">
              ...
              <p class="sidebar-text">
                Access all essential learning materials, guides, and documents related to your networking course.
