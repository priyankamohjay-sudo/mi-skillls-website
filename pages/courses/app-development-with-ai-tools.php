    ...
    <div class="hero-text-area centerd">
      ...
      <nav aria-label="breadcrumb">
        <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
          ...
          <li class="breadcrumb-item active">App Development with AI Tools</li>
        </ul>
      </nav>
    </div>
  </div>
      ...
      <div class="col-12 col-xl-8  ">
        <div class="service-content-area">
          <div class="featured-img-area part"><img class="feat-img img-fluid"
              src="<?=BASE_URL?>assets/images/services/app-3.jpg" alt="featured image"></div>
          <div class="service-content">
            <div class="part">
              <h2 class="service-title">App Development with AI Tools</h2>
              <h3 class="service-title">Course Overview</h3>
             <p class="info-text">This course introduces students to modern mobile app development enhanced with AI-powered tools. Learners will understand how to design, develop, and deploy mobile applications for Android, iOS, and cross-platform environments using efficient and intelligent workflows.
                </p>
                <p class="info-text">The program is designed for beginners as well as aspiring developers who want to build scalable mobile applications faster using AI-assisted development. Through hands-on projects and practical sessions, students will gain real-world experience in creating feature-rich mobile apps.</p>
              ...
              <div class="two-cols-img ">
                <div class="row">
                  <div class="col-12 col-md-6 mb-3">
                    <div class="img-col"><img class="img-fluid" src="<?=BASE_URL?>assets/images/services/app-1.jpg"
                        loading="lazy" alt="service single image "></div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="img-col"><img class="img-fluid" src="<?=BASE_URL?>assets/images/services/app-2.jpg" loading="lazy"
            ...
            <div class="part pb-5">
              <h3 class="service-title">What You’ll Learn in This Course</h3>
                <ul>
                <li>Fundamentals of mobile app development</li>
                <li>Android, iOS, and cross-platform development concepts</li>
                <li>Using AI tools to speed up app development</li>
                <li>UI/UX design principles for mobile applications</li>
                <li>App testing, debugging, and deployment</li>
                <li>Building real-world mobile applications</li>
                </ul>
            </div>
           ...
           <div class="part pb-5">
            ...
            <div class="table-responsive">
              <table class="custom-table">
                <tbody>
                  <tr>
                    <td>
                      <strong>Introduction to App Development & AI Tools</strong><br>
                        Understand the basics of mobile app development and how AI tools enhance coding, design, and productivity. Learn modern development workflows used in the industry.
                        </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    Learn how to build Android applications using industry-standard tools and frameworks. Understand app structure, UI design, and deployment on Android devices.
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      <strong>iOS Development</strong><br>
                        Explore the fundamentals of iOS app development including interface design and application lifecycle. Learn how to build and deploy apps for Apple devices.
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    Understand how to create apps that run on both Android and iOS using a single codebase. Learn frameworks that improve efficiency and reduce development time.                    </td>
                  </tr>

                  <tr>
                    <td>
                      <strong>UI/UX Design for Mobile Apps</strong><br>
                        Learn to design intuitive and user-friendly interfaces for mobile applications. Understand best practices for enhancing user experience.
                    </td>
                  </tr>
                   <tr>
                    <td>
                      <strong>Real-World Projects & Case Studies</strong><br>
                        Work on real app development projects to apply your knowledge. Build practical experience and create a strong portfolio of mobile applications.
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="part pb-5">
              ...
              <ul>
                <li>Available on both mobile app and desktop platform</li>
                <li>Learn online or offline at your convenience</li>
                <li>Designed for students and working professionals</li>
                <li>Build job-ready Mobile App Development skills</li>
              </ul>
            </div>
          ...
          <div class="table-responsive">
            <table class="custom-table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>App Development with AI Tools</td>
                </tr>
            ...
            <div class="part">
              <div class="info-items-list">
                <div class="row">
                  <h3 class="service-title pb-4">Course Highlights</h3>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">01.</span>
                      <div class="info-content">
                        <h5 class="info-title">Hands-on training with real app development projects</h5>
                        <p class="info-text"> Build real mobile applications to understand how apps are developed and deployed in real-world scenarios.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">02.</span>
                      <div class="info-content">
                        <h5 class="info-title">Beginner-friendly with step-by-step guidance</h5>
                        <p class="info-text">Designed for beginners with structured lessons that guide you from basic concepts to advanced development skills.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">03.</span>
                      <div class="info-content">
                        <h5 class="info-title">Industry-relevant tools and AI-powered development</h5>
                        <p class="info-text">Learn modern frameworks, tools, and AI technologies used to speed up app development.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">04.</span>
                      <div class="info-content">
                        <h5 class="info-title">Project-based learning for practical experience</h5>
                        <p class="info-text">Create complete mobile apps that help you gain hands-on experience and strengthen your portfolio.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="faq-accordion" id="accordion">
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-1" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Yes, the course starts with basic concepts and gradually moves to advanced app development topics.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-2" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Basic programming knowledge is helpful but not mandatory. Everything will be taught step by step.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-3" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Yes, you will work on real-world projects and create functional mobile applications.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-4" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        You can pursue roles like Mobile App Developer, Android Developer, iOS Developer, or Cross-Platform Developer.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-5" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Yes, you can access the course both online and offline through our mobile and desktop applications.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="sidebar-pane">
            ...
            <ul class="list">
              ...
              <li class="list-item"><i class="flaticon-strategy font-icon"></i><a href="<?= BASE_URL ?>course/data-analytics-with-gen-ai"> Data Analytics with Gen AI<i
                    class="bi bi-arrow-right icon "></i></a></li>
              <li class="list-item active"><i class="flaticon-nanotechnology font-icon"></i><a href="<?= BASE_URL ?>course/app-development-with-ai-tools"> App Development with AI Tools<i
                    class="bi bi-arrow-right icon "></i></a></li>
  ...
  <div class="cta-wrapper">
    <div class="container">
      <div class="sec-heading  centered mb-0 ">
        ...
        <h4 class=" title    wow fadeInUp" data-wow-delay=".4s">Career Opportunity - MiSkills Advantage</h4>
          <hr style="width:85px; margin:10px auto; border:2px solid #fff;">
        <p class="info-text   wow fadeInUp " data-wow-delay=".6s">Students who maintain a minimum of 85% attendance in this course become eligible to apply for job opportunities through the Mi Skills platform. This initiative is designed to reward consistent learners with direct access to career opportunities, helping them transition smoothly into the field of Artificial Intelligence and Machine Learning.</p>
      </div>
    </div>
