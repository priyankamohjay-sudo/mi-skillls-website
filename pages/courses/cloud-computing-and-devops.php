        ...
        <div class="service-sidebar ">
          <div class="sidebar-pane">
            ...
            <ul class="list">
              ...
              <li class="list-item active"><i class="flaticon-web-domain font-icon"></i><a href="cloud-computing-and-devops"> Cloud Computing & DevOps<i class="bi bi-arrow-right icon "></i></a></li>
