    ...
    <div class="hero-text-area centerd">
      ...
      <nav aria-label="breadcrumb">
        <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
          ...
          <li class="breadcrumb-item active">Cybersecurity AI & Cloud Security</li>
        </ul>
      </nav>
    </div>
  </div>
      ...
      <div class="col-12 col-xl-8  ">
        <div class="service-content-area">
          <div class="featured-img-area part"><img class="feat-img img-fluid"
              src="<?=BASE_URL?>assets/images/services/cyber-1.webp" alt="featured image"></div>
          <div class="service-content">
            <div class="part">
              <h2 class="service-title">Cybersecurity AI & Cloud Security</h2>
              <h3 class="service-title">Course Overview</h3>
               <p class="info-text">This course introduces students to the fundamentals of Cybersecurity with a focus on AI-driven security and cloud protection. Learners will understand how to secure systems, networks, and data from modern cyber threats while leveraging AI and cloud technologies for enhanced security.
                </p>

                <p class="info-text">
                The program is designed for beginners as well as those looking to build advanced security skills. Through hands-on projects and practical sessions, students will gain real-world experience in identifying vulnerabilities, preventing attacks, and securing cloud-based environments.
                </p>
              ...
              <div class="two-cols-img ">
                <div class="row">
                  <div class="col-12 col-md-6 mb-3">
                    <div class="img-col"><img class="img-fluid" src="<?=BASE_URL?>assets/images/services/cyber-2.webp"
                        loading="lazy" alt="service single image "></div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="img-col"><img class="img-fluid" src="<?=BASE_URL?>assets/images/services/cyber-3.webp" loading="lazy"
          ...
          <div class="part pb-5">
            ...
            <div class="part pb-5">
              ...
              <ul>
                ...
                <li>Build job-ready Cybersecurity & Cloud Security skills</li>
              </ul>
            </div>
            ...
            <table class="custom-table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>Cybersecurity - AI & Cloud Security</td>
                </tr>
                  ...
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">01.</span>
                      <div class="info-content">
                        <h5 class="info-title">Hands-on training with real-world security scenarios</h5>
                        <p class="info-text">Work on real-life cybersecurity cases to understand how threats are identified and prevented.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">02.</span>
                      <div class="info-content">
                        ...
                        <p class="info-text">Designed for beginners with structured lessons that guide you from basic concepts to advanced security practices.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">03.</span>
                      <div class="info-content">
                        ...
                        <p class="info-text">Learn modern cybersecurity tools, cloud security practices, and AI-based threat detection techniques.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">04.</span>
                      <div class="info-content">
                        ...
                        <p class="info-text">Build real projects that help you gain hands-on experience and strengthen your security skills.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="faq-accordion" id="accordion">
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-1" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                       Yes, the course starts with basic cybersecurity concepts and gradually moves to advanced topics.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-2" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        No prior experience is required. Everything will be taught from scratch.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-3" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                       Yes, the course includes hands-on projects and real-world security case studies.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-4" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                       You can pursue roles like Cybersecurity Analyst, Security Engineer, or Cloud Security Specialist.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="sidebar-pane">
            <h2 class="sidebar-title">list of Courses</h2>
             <ul class="list">
              ...
              <li class="list-item active"><i class="flaticon-nanotechnology font-icon"></i><a href="<?= BASE_URL ?>course/cybersecurity-ai-and-cloud-security">Cybersecurity - AI & Cloud Security<i
                    class="bi bi-arrow-right icon "></i></a></li>
