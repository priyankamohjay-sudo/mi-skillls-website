    ...
    <div class="hero-text-area centerd">
      ...
      <nav aria-label="breadcrumb">
        <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
          ...
          <li class="breadcrumb-item active">Data Analytics with Gen AI</li>
        </ul>
      </nav>
    </div>
  </div>
      ...
      <div class="col-12 col-xl-8  ">
        <div class="service-content-area">
          <div class="featured-img-area part"><img class="feat-img img-fluid"
              src="<?=BASE_URL?>assets/images/services/data-analytics-1.webp" alt="featured image"></div>
          <div class="service-content">
            <div class="part">
              <h2 class="service-title">Data Analytics with Gen AI</h2>
              <h3 class="service-title">Course Overview</h3>
             <p class="info-text">This course introduces students to the fundamentals of Data Analytics combined with Generative AI, focusing on extracting insights from data and enhancing analysis using AI-powered tools. Learners will understand how to work with data, identify patterns, and generate meaningful reports to support business decisions.
                </p>
                <p class="info-text">
                The program is designed for beginners as well as those looking to upgrade their analytical skills using modern technologies. Through hands-on projects and practical sessions, students will gain experience in analyzing real-world datasets and leveraging Generative AI for smarter insights.
                </p>
              ...
              <div class="two-cols-img ">
                <div class="row">
                  <div class="col-12 col-md-6 mb-3">
                    <div class="img-col"><img class="img-fluid" src="<?=BASE_URL?>assets/images/services/data-analytics-2.webp"
                        loading="lazy" alt="service single image "></div>
                  </div>
                  <div class="col-12 col-md-6">
                    <div class="img-col"><img class="img-fluid" src="<?=BASE_URL?>assets/images/services/data-analytics-3.webp" loading="lazy"
            ...
            <div class="part pb-5">
              <h3 class="service-title">What You’ll Learn in This Course</h3>
                <ul>
                <li>Fundamentals of Data Analytics and Generative AI</li>
                <li>Data collection, cleaning, and preprocessing techniques</li>
                <li>Data analysis and interpretation methods</li>
                <li>Data visualization and reporting</li>
                <li>Using Generative AI for data insights and automation</li>
                <li>Working with real-world datasets and tools</li>
                </ul>
            </div>
           ...
           <div class="part pb-5">
            ...
            <div class="part pb-5">
              ...
              <ul>
                ...
                <li>Build job-ready AI & ML skills</li>
              </ul>
            </div>
                  ...
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">01.</span>
                      <div class="info-content">
                        ...
                        <p class="info-text">Work on real industry datasets to understand how AI and ML are applied in practical scenarios.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                  ...
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">03.</span>
                      <div class="info-content">
                        ...
                        <p class="info-text">Learn using popular tools like Python, ML libraries, and frameworks used in real-world projects.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
              ...
              <div class="faq-accordion" id="accordion">
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-1" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Yes, this course starts from the basics and gradually moves to advanced concepts.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-2" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Basic programming knowledge is helpful but not mandatory. Python basics will be covered.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-3" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Yes, the course includes hands-on projects and real-world case studies.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-4" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        You can pursue roles like AI Developer, Machine Learning Engineer, or Data Analyst.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="sidebar-pane">
            ...
            <ul class="list">
              ...
              <li class="list-item "><i class="flaticon-nanotechnology font-icon"></i><a href="<?= BASE_URL ?>course/cybersecurity-ai-and-cloud-security">Cybersecurity - AI & Cloud Security<i
                    class="bi bi-arrow-right icon "></i></a></li>
              <li class="list-item active"><i class="flaticon-strategy font-icon"></i><a href="<?= BASE_URL ?>course/data-analytics-with-gen-ai"> Data Analytics with Gen AI<i
                    class="bi bi-arrow-right icon "></i></a></li>
