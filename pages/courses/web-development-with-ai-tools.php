    ...
    <div class="hero-text-area centerd">
      ...
      <nav aria-label="breadcrumb">
        <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
          ...
          <li class="breadcrumb-item active">Web Development with AI Tools</li>
        </ul>
      </nav>
    </div>
  </div>
      ...
      <div class="col-12 col-xl-8  ">
        <div class="service-content-area">
          ...
          <div class="service-content">
            <div class="part">
              <h2 class="service-title">Web Development with AI Tools</h2>
              <h3 class="service-title">Course Overview</h3>
             <p class="info-text">
            This course introduces students to modern web development combined with AI-powered tools, focusing on building fast, responsive, and user-friendly websites. Learners will understand how frontend and backend technologies work together to create complete web applications.
            </p>

            <p class="info-text">
            The program is designed for beginners as well as aspiring developers who want to build full-stack web applications using efficient and industry-relevant tools. Through hands-on projects and practical sessions, students will gain real-world experience in developing dynamic websites and web apps.
            </p>
            </div>
            <div class="part">
            ...
            <div class="part pb-5">
              ...
              <ul>
                <li>Fundamentals of web development (frontend & backend)</li>
                <li>Full stack development concepts and workflows</li>
                <li>Using AI tools to speed up development</li>
                <li>Building responsive and interactive websites</li>
                <li>Working with databases and server-side logic</li>
                <li>Creating real-world web applications</li>
                </ul>
            </div>
           ...
           <div class="part pb-5">
            ...
            <div class="table-responsive">
              <table class="custom-table">
                <tbody>
                  <tr>
                    <td>
                      <strong>Introduction to Web Development & AI Tools</strong><br>
                      Understand the basics of web development and how AI tools enhance coding, design, and productivity. Learn modern workflows used to build fast and efficient web applications.
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      ...
                      Learn how to design and develop user interfaces using HTML, CSS, and JavaScript. Understand how to create responsive and interactive websites for better user experience.
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      ...
                      Explore server-side development, databases, and APIs. Learn how to manage data, authentication, and application logic to build dynamic web applications.
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      ...
                      Understand how frontend and backend work together to build complete web applications. Learn to develop, test, and deploy full-stack projects using modern tools and frameworks.
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>
                      ...
                      Work on real-world website and web app projects to apply your knowledge. Build practical experience and create a strong portfolio for career growth.
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="part pb-5">
              ...
              <ul>
                ...
                <li>Build job-ready Web Development skills</li>
              </ul>
            </div>
            ...
            <table class="custom-table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>Web Development with AI Tools</td>
                </tr>
                  ...
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">01.</span>
                      <div class="info-content">
                        <h5 class="info-title">Hands-on training with real web development projects</h5>
                        <p class="info-text">Build real websites and applications to understand how development works in real-world scenarios.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">02.</span>
                      <div class="info-content">
                        ...
                        <p class="info-text">Designed for beginners with structured lessons that guide you from basic concepts to development skills.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">03.</span>
                      <div class="info-content">
                        ...
                        <p class="info-text">Learn modern frameworks, tools, and AI technologies used to build scalable web applications.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 ">
                    <div class="info-item"><span class="info-number ">04.</span>
                      <div class="info-content">
                        ...
                        <p class="info-text">Create complete web projects that help you gain hands-on experience and strengthen your portfolio.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="faq-accordion" id="accordion">
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-1" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Yes, the course starts with basic web development concepts and gradually moves to advanced topics.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-2" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Basic knowledge is helpful but not mandatory. Everything will be taught step by step.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  <div class="card-header" id="heading-3">
                    <h5 class="mb-0 faq-title">
                      <button class="btn btn-link faq-btn collapsed" data-bs-toggle="collapse"
                        ...
                        Will I build real websites during the course?
                      </button>
                    </h5>
                  </div>
                  <div class="collapse" id="collapse-3" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        Yes, you will work on real-world projects and develop functional websites and web applications.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-4" data-bs-parent="#accordion">
                    <div class="card-body">
                      <p class="faq-answer">
                        You can pursue roles like Frontend Developer, Backend Developer, or Full Stack Developer.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-2">
                  ...
                  <div class="collapse" id="collapse-5" data-bs-parent="#accordion">
                    <div class="card-body">
                     <p class="faq-answer">
                Yes, after purchasing the course, you can choose between online or offline mode from the app. For offline learning, you need to visit our institute.
                </p>
                    </div>
                  </div>
                </div>
