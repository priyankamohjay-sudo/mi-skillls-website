...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
       ...
       <link rel="icon" href="assets/images/fav-icon/logo-new.png">
        ...
        <title> Mi Skills   |   Terms and Conditions</title>
  </head>
      ...
      <div class="col-12 col-lg-9 mx-auto">
        <div class="post-main-area">
          <div class="post-content">
            ...
            <p class="post-text">
              Welcome to MISKILLS. By subscribing to or using our educational services, you agree to these Terms &amp; Conditions.
              If you do not agree, please do not use the platform.
            </p>

            <h2 class="post-heading">2. Subscription &amp; Access</h2>
            <p class="post-text">
              MISKILLS offers subscription-based online learning content. Upon successful payment, you receive access to the
            ...
            <p class="post-text">
              All payments are processed securely via Razorpay. By completing a payment, you authorize Razorpay to process your transaction.
            </p>
            <p class="post-text">
              You must provide accurate billing information. Failed or disputed payments may result in restricted access.
            </p>
            ...
            <p class="post-text">
              We reserve the right to suspend or terminate accounts involved in misuse, abuse, or violation of platform policies.
            </p>

            <h2 class="post-heading">6. Changes to Terms</h2>
            <p class="post-text">
              MISKILLS may update these terms periodically. Continued use of the platform indicates acceptance of updated terms.
            </p>
