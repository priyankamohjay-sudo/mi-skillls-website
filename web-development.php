        ...
        <div class="row">
          ...
          <div class="col-12 col-xl-8  ">
            <div class="service-content-area">
              <div class="featured-img-area part"><img class="feat-img img-fluid" src="assets/images/services/programming-background-collage.jpg" alt="featured image"></div>
              <div class="service-content">
                  ...
                  <div class="two-cols-img ">
                    <div class="row">
                      <div class="col-12 col-md-6 mb-3">
                        <div class="img-col"><img class="img-fluid" src="assets/images/services/website-1.jpg" loading="lazy" alt="service single image "></div>
                      </div>
                      <div class="col-12 col-md-6">
                        <div class="img-col"><img class="img-fluid" src="assets/images/services/website.jpg" loading="lazy" alt="service single image "></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="part">
                  ...
                  <p class="info-text">Our backend training helps students understand how applications work behind the scenes. From handling data to managing servers, students learn how to build secure and scalable systems.</p>
                  <ul>
                 ...
                 <div class="part">
                  ...
                  <p class="info-text">Students learn how frontend and backend work together as a complete system. This full-stack approach prepares them to handle complete projects independently.</p>
                  <ul>
                      ...
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">01.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">Learn the exact skills that companies look for today. This course prepares students to build real websites and applications using modern development practices followed in the industry.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">02.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">Instead of learning isolated technologies, students gain a complete understanding of frontend, backend, and how both work together in real-world projects.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">03.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">Hands-on learning through live projects helps students apply concepts, improve problem-solving skills, and build a strong portfolio that stands out to employers.</p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 ">
                        <div class="info-item"><span class="info-number ">04.</span>
                          <div class="info-content">
                            ...
                            <p class="info-text">The course is designed to support students in internships, placements, and freelance opportunities by focusing on job-oriented skills and practical experience.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="card mb-2">
                        <div class="card-header " id="heading-1">
                          <h5 class="mb-0 faq-title">
                            <button class="btn btn-link  faq-btn  collapsed " data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">Are the web development courses beginner-friendly?</button>
                          </h5>
                        </div>
                        <div class="collapse " id="collapse-1" aria-labelledby="collapse-1" data-bs-parent="#accordion">
                          <div class="card-body">
                            <p class="faq-answer">Yes. Our web development courses are designed for beginners as well as students with basic technical knowledge. We start from fundamentals and gradually move to advanced concepts with hands-on practice.</p>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-2">
                        <div class="card-header " id="heading-2">
                          <h5 class="mb-0 faq-title">
                            <button class="btn btn-link  faq-btn  collapsed " data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="true" aria-controls="collapse-2">Will I receive updates and new course content in the future?</button>
                          </h5>
                        </div>
                        <div class="collapse " id="collapse-2" aria-labelledby="collapse-2" data-bs-parent="#accordion">
                          <div class="card-body">
                            <p class="faq-answer">Yes. Students get access to future updates, new modules, and improvements added to the course to keep the curriculum aligned with the latest industry trends.</p>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-2">
                        <div class="card-header " id="heading-3">
                          <h5 class="mb-0 faq-title">
                            <button class="btn btn-link  faq-btn  collapsed " data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="true" aria-controls="collapse-3">Do I get certificates after completing the course?</button>
                          </h5>
                        </div>
                        <div class="collapse " id="collapse-3" aria-labelledby="collapse-3" data-bs-parent="#accordion">
                          <div class="card-body">
                            <p class="faq-answer">Yes. Students receive a course completion certificate after successfully finishing the training and project work, which can be used for job applications and internships.</p>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-2">
                        <div class="card-header " id="heading-4">
                          <h5 class="mb-0 faq-title">
                            <button class="btn btn-link  faq-btn  collapsed " data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="true" aria-controls="collapse-4">Will this course help me with internships and placements?</button>
                          </h5>
                        </div>
                        <div class="collapse " id="collapse-4" aria-labelledby="collapse-4" data-bs-parent="#accordion">
                          <div class="card-body">
                            <p class="faq-answer">Yes. The course focuses on practical projects, real-world scenarios, and job-oriented skills that help students prepare for internships, placements, and entry-level developer roles.</p>
                          </div>
                        </div>
                      </div>
                    </div>
